 ...
 */
public class Request_RefForm extends BaseForm {
	String action;//アクション
	...
	ArrayList<Request_RefElement> iraiList = new ArrayList<>();//原図依頼詳細のデータ
	...
	public ArrayList<Request_RefElement> getIraiList() {
		return iraiList;
	}

	public void setIraiList(ArrayList<Request_RefElement> iraiList) {
		this.iraiList = iraiList;
	}

	public ArrayList<Request_RefElement> getIrai_List() {
		return irai_List;
	}
