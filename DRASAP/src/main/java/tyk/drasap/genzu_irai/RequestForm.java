...
public class RequestForm extends BaseForm {
	ArrayList<String> iraiList = new ArrayList<>();//依頼内容のリスト
	ArrayList<RequestElement> list = new ArrayList<>();//プリンタのリスト
	ArrayList<String> genzuNameList = new ArrayList<>();//原図内容のリスト
	ArrayList<String> syukusyouList = new ArrayList<>();//縮小リスト
	ArrayList<String> saizuList = new ArrayList<>();//サイズリスト
	...
	public boolean isInputedLine1() {
		...
		// 開始図番
		// 終了図番
		if (!"".equals(gouki1) || !"".equals(genzu1) || !"".equals(kaisiNo1) || !"".equals(syuuryouNo1)) {
			return true;
		}
		// 部数
		// 縮小
		// サイズ
		if (!"".equals(busuu1) || "1".equals(syukusyou1) || !"".equals(size1)) {
			return true;
		}
	...
	public boolean isInputedLine2() {
		...
		// 開始図番
		// 終了図番
		if (!"".equals(gouki2) || !"".equals(genzu2) || !"".equals(kaisiNo2) || !"".equals(syuuryouNo2)) {
			return true;
		}
		// 部数
		// 縮小
		// サイズ
		if (!"".equals(busuu2) || "1".equals(syukusyou2) || !"".equals(size2)) {
			return true;
		}
	...
	public boolean isInputedLine3() {
		...
		// 開始図番
		// 終了図番
		if (!"".equals(gouki3) || !"".equals(genzu3) || !"".equals(kaisiNo3) || !"".equals(syuuryouNo3)) {
			return true;
		}
		// 部数
		// 縮小
		// サイズ
		if (!"".equals(busuu3) || "1".equals(syukusyou3) || !"".equals(size3)) {
			return true;
		}
	...
	public boolean isInputedLine4() {
		...
		// 開始図番
		// 終了図番
		if (!"".equals(gouki4) || !"".equals(genzu4) || !"".equals(kaisiNo4) || !"".equals(syuuryouNo4)) {
			return true;
		}
		// 部数
		// 縮小
		// サイズ
		if (!"".equals(busuu4) || "1".equals(syukusyou4) || !"".equals(size4)) {
			return true;
		}
	...
	public boolean isInputedLine5() {
		...
		// 開始図番
		// 終了図番
		if (!"".equals(gouki5) || !"".equals(genzu5) || !"".equals(kaisiNo5) || !"".equals(syuuryouNo5)) {
			return true;
		}
		// 部数
		// 縮小
		// サイズ
		if (!"".equals(busuu5) || "1".equals(syukusyou5) || !"".equals(size5)) {
			return true;
		}
	...
	//---------------------------------------------------------- getter,setter
	public ArrayList<RequestElement> getList() {
		return list;
	}

	public void setList(ArrayList<RequestElement> list) {
		this.list = list;
	}

	public ArrayList<String> getGenzuNameList() {
		return genzuNameList;
	}

	public ArrayList<String> getSyukusyouList() {
		return syukusyouList;
	}

	public ArrayList<String> getSaizuList() {
		return saizuList;
	}

	public void setGenzuNameList(ArrayList<String> genzuNameList) {
	...
	public void setSyukusyouList(ArrayList<String> syukusyouList) {
		this.syukusyouList = syukusyouList;
	}

	public void setSaizuList(ArrayList<String> saizuList) {
	 ...
	 * @return
	 */
	public ArrayList<String> getIraiList() {
		return iraiList;
	}
