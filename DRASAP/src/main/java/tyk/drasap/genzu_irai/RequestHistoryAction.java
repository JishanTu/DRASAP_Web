...
public class RequestHistoryAction extends Action {
	...
	private static Category category = Category.getInstance(RequestHistoryAction.class.getName());
	static{
		try{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		RequestHistoryForm historyForm = (RequestHistoryForm)form;	
	 ...
	 * @throws Exception
	 */
	private ArrayList crtHistoryList() throws Exception {
		// 事前に今日より10日前を求めておく
		...
		// 次に降順にソートする。
		ArrayList historyList2 = new ArrayList();
