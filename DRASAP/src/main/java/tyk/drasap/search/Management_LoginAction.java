...
public class Management_LoginAction extends BaseAction {
	// --------------------------------------------------------- Instance Variables
	// --------------------------------------------------------- Methods
	...
	public String execute(
			@ModelAttribute("loginForm") Management_LoginForm form,
			HttpServletRequest request,
			HttpServletResponse response,
			Model errors)
			throws Exception {
		category.debug("start");
		Management_LoginForm loginForm = form;
	...
	private void chkPasswd(User user, String passwd, Model errors) {
		...
		try {
			...
			// for ユーザー
			MessageSourceUtil.addAttribute(errors, "message", messageSource.getMessage("search.delHost.FileNotFound", new Object[] { passwdFile }, null));
			// for システム管理者
