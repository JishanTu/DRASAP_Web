...
public class SearchResultElement {
	...
	public SearchResultElement(String newDrwgNo, String newFileName, String newFileType, String newPathName, String newAclBalloon) {
		...
		thumbnailName = StringUtils.isBlank(newFileName) ? drwgNoFormated : DrasapUtil.getBaseName(newFileName);
		thumbnailName = thumbnailName + "_thumb.jpg";
	}
	...
	/**
	 * thumbnailNameを設定します。
	 * @param thumbnailName thumbnailName
	 */
