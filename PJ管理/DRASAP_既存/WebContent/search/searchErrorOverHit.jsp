...
<logic:equal value="Japanese" name="user" property="language" scope="session">
    ...
    <logic:present name="drasapInfo" scope="session" >
	    <bean:write name="drasapInfo" property="searchLimitCount" scope="session" />
    </logic:present>
    件です。<br />
    検索条件を絞り込んでください。<br />
    </span>
...
<logic:notEqual value="Japanese" name="user" property="language" scope="session">
    ...
    <hr style="width: 50%; color: #FF6600;" />
    <span class="normal12">
    The drawings that can meet the search condition are&nbsp;
    <logic:present name="hit" scope="request" >
	<bean:write name="hit" scope="request" />
    </logic:present>
    .<br />
   ...
   .<br />
    Please specific search condition.<br />
    </span>
</logic:notEqual>
</center>
