...
public class DateCheck {
	...
	public static int convertIntYMD(String ymd) {
		try{
			...
			switch(cnt){
				case 1:
					int intYmd = (new Integer(ymd)).intValue();
					// 年を確認
				...
				case 3:
					int yyyy = (new Integer(tokenizer.nextToken())).intValue();
					int mm = (new Integer(tokenizer.nextToken())).intValue();
					int dd = (new Integer(tokenizer.nextToken())).intValue();
