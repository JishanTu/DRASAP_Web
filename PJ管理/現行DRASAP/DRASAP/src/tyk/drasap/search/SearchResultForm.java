...
public class SearchResultForm extends ActionForm {
	...
	String dispAttr5;
	String dispAttr6;
	ArrayList<String> dispNameList = new ArrayList<String>();// 表示属性プルダウンの名称リスト
	ArrayList<String> dispKeyList = new ArrayList<String>();// 表示属性プルダウンのKeyリスト
	String outputPrinter;// 出力プロッタ
	ArrayList<String> printerNameList = new ArrayList<String>();// 出力プロッタのプルダウンの名称
	ArrayList<String> printerKeyList = new ArrayList<String>();// 出力プロッタのプルダウンのKey
	String dispNumberPerPage = "0";// 1ページ当たりの表示件数
	String dispNumberOffest = "0";// 検索結果を表示するときのOffセット値。iterateタグで使用される。
							// 1件目から表示するときは、0となる。
	ArrayList<SearchResultElement> searchResultList = new ArrayList<SearchResultElement>();// 検索結果を格納する。
