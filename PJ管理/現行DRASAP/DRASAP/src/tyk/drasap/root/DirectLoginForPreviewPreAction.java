 ...
 */
public class DirectLoginForPreviewPreAction extends Action {
	private static Category category = Category.getInstance(DirectLoginForPreviewPreAction.class.getName());
	/** 
	 * Method execute
